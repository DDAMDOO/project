						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<div class="collapse" id="pagesCollapseAuth"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="resources/resources_main/login.html">Login</a><a
											class="nav-link"
											href="resources/resources_main/register.html">Register</a><a
											class="nav-link"
											href="resources/resources_main/password.html">Forgot
											Password</a>
									</nav>
								</div>
								<a class="nav-link collapsed" href="#" data-toggle="collapse"
								...
								<div class="collapse" id="pagesCollapseError"
									...
									data-parent="#sidenavAccordionPages">
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="resources/resources_main/401.html">401
											Page</a><a class="nav-link"
											href="resources/resources_main/404.html">404 Page</a><a
											class="nav-link" href="resources/resources_main/500.html">500
											Page</a>
									</nav>
								</div>
							</nav>
