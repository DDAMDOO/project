...
<script>
	...
	function btn_click(a){
		console.log(a);
		$.get("fav", {'mycode':a, 'mycase':2}, recvSal4)
	}
	function recvSal3(data) {
		$("#mytable").append("<tr><th>산 이름</th><th>산 주소</th><th>등산로 이름</th><th>등산로 길이</th><th>등산 소요시간</th><th>등산로 난이도</th><th>위험 요소</th><th>즐겨찾기</th></tr>")
		var arr = new Array();
		$.each(data, function(i, v) {
			...
			$("#mytable").append(
					"<tr><td>" + v.m_name + "</td><td>" + v.m_addr
							...
							+ v.climb_risk
							+ "</td><td><button class=\"btn\" onclick=\"btn_click();\" data-idx=\""+i+"\">즐겨찾기 해제</button></td></tr>")
		})
		$(".btn").click(function(){
