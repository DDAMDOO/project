...
<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
	<div class="sb-sidenav-menu">
		<div class="nav">
			...
			<a class="nav-link" href="resources/resources_main/index.html">
			...
			<div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
				<nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
					...
					<div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
						...
						<nav class="sb-sidenav-menu-nested nav">
							<a class="nav-link" href="resources/resources_main/login.html">Login</a><a class="nav-link"
								href="resources/resources_main/register.html">Register</a><a class="nav-link"
